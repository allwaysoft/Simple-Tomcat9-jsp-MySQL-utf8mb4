...
--
CREATE DATABASE IF NOT EXISTS `dbblooddonor` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
create user 'dbblooddonor'@'%' IDENTIFIED BY 'dbblooddonor';
GRANT ALL PRIVILEGES ON *.* TO 'dbblooddonor'@'%' ;
